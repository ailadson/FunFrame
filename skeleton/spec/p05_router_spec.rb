...
describe Route do
  ...
  describe '#matches?' do
    it 'matches simple regular expression' do
      index_route = Route.new('/users', :get, 'x', :x)
    ...
    it 'matches regular expression with capture' do
      index_route = Route.new('/users/:id', :get, 'x', :x)
    ...
    it 'correctly doesn\'t match regular expression with capture' do
      index_route = Route.new('/users/:id', :get, 'UsersController', :index)
  ...
  describe '#run' do
    ...
    it 'instantiates controller and invokes action' do
      ...
      index_route = Route.new('/users', :get, dummy_controller_class, :index)
...
describe Router do
  ...
  describe 'http method (get, put, post, delete)' do
    ...
    it 'adds a route when an http method method is called' do
      router = Router.new
      router.get '/users', ControllerBase, :index
